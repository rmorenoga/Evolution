...
public class CalculateFitnessPR8 extends ObjectiveFunction{
...
//*******************************************************************************************************************************
		...
		ret = vrep.simxLoadScene(clientID, "/home/rodr/EvolWork/Modular/ModularCPGA1.ttt", 0, vrep.simx_opmode_oneshot_wait);	
...
//*******************************************************************************************************************	    
	  ...
	  //Load third maze and starting the simulation
	  		ret = vrep.simxLoadScene(clientID, "/home/rodr/EvolWork/Modular/ModularCPGA3.ttt", 0, vrep.simx_opmode_oneshot_wait);
	  		ret = vrep.simxStartSimulation(clientID, vrep.simx_opmode_oneshot_wait);
...
//*******************************************************************************************************************************
		 ...
		 //ret = vrep.simxSetStringSignal(clientID, "ControlParam", strCP, vrep.simx_opmode_oneshot_wait) ;
	  	...
	  	//Load second maze and starting the simulation
	  		ret = vrep.simxLoadScene(clientID, "/home/rodr/EvolWork/Modular/ModularCPGA2.ttt", 0, vrep.simx_opmode_oneshot_wait);
	  		ret = vrep.simxStartSimulation(clientID, vrep.simx_opmode_oneshot_wait);
...
//*******************************************************************************************************************************
		 ...
		 ret = vrep.simxSetStringSignal(clientID, "ControlParam", strCP, vrep.simx_opmode_oneshot_wait) ;
	  	...
	  	//Load second maze and starting the simulation
	  		ret = vrep.simxLoadScene(clientID, "/home/rodr/EvolWork/Modular/ModularCPGA4.ttt", 0, vrep.simx_opmode_oneshot_wait);
	  		ret = vrep.simxStartSimulation(clientID, vrep.simx_opmode_oneshot_wait);
