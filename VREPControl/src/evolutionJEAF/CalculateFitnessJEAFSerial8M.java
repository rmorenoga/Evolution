...
public class CalculateFitnessJEAFSerial8M extends ObjectiveFunction{
	...
	//	float GoalX = 0f;
		...
		FloatWA ControlParam =new FloatWA(32);
		float[] CP = new float[32];
		for (int i=0;i<32;i++)
		{
...
//*******************************************************************************************************************************
		...
		ret = vrep.simxLoadScene(clientID, "/home/rodrigo/V-REP/Modular/ModularCPGA1M.ttt", 0, vrep.simx_opmode_oneshot_wait);	
...
//*******************************************************************************************************************	    
	  ...
	  //Load third maze and starting the simulation
	  		ret = vrep.simxLoadScene(clientID, "/home/rodrigo/V-REP/Modular/ModularCPGA3M.ttt", 0, vrep.simx_opmode_oneshot_wait);
	  		ret = vrep.simxStartSimulation(clientID, vrep.simx_opmode_oneshot_wait);
...
//*******************************************************************************************************************************
		 ...
		 //ret = vrep.simxSetStringSignal(clientID, "ControlParam", strCP, vrep.simx_opmode_oneshot_wait) ;
	  	...
	  	//Load second maze and starting the simulation
	  		ret = vrep.simxLoadScene(clientID, "/home/rodrigo/V-REP/Modular/ModularCPGA2M.ttt", 0, vrep.simx_opmode_oneshot_wait);
	  		ret = vrep.simxStartSimulation(clientID, vrep.simx_opmode_oneshot_wait);
...
//*******************************************************************************************************************************
		 ...
		 ret = vrep.simxSetStringSignal(clientID, "ControlParam", strCP, vrep.simx_opmode_oneshot_wait) ;
	  	...
	  	//Load second maze and starting the simulation
	  		ret = vrep.simxLoadScene(clientID, "/home/rodrigo/V-REP/Modular/ModularCPGA4M.ttt", 0, vrep.simx_opmode_oneshot_wait);
	  		ret = vrep.simxStartSimulation(clientID, vrep.simx_opmode_oneshot_wait);
