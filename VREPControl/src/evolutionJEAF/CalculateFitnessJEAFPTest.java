...
public class CalculateFitnessJEAFPTest extends ObjectiveFunction{
	...
	public double evaluate(double[] values) {
		...
		//remoteApi vrep = EvolutionJEAFPTest.vrep;
		//vrep.simxFinish(-1); // just in case, close all opened connections
		int clientID = -1;
		clientID = vrep.simxStart("127.0.0.1",19997+myRank,true,true,5000,5);
		/*if(myRank==0){
...
//*******************************************************************************************************************	    
	  ...
	  //Load third maze and starting the simulation
	  	    ...
	  	    if (out2.getArray()[0]==0)
	  	    {
	  	    	fitness3 = out2.getArray()[1];
	  	    }else if(out2.getArray()[1]==0)
	  	    {
	  	     fitness3 = (out2.getArray()[0]*(100/7))+60;	
	  	    }
	  		System.out.println("Fitness = "+Float.toString(fitness3));
...
//*******************************************************************************************************************************
		 ...
		 ret = vrep.simxSetStringSignal(clientID, "ControlParam", strCP, vrep.simx_opmode_oneshot_wait) ;
	  	...
	  	//Load second maze and starting the simulation
	  	    ...
	  	    if (out2.getArray()[0]==0)
	  	    {
	  	    	fitness2 = out2.getArray()[1];
	  	    }else if(out2.getArray()[1]==0)
	  	    {
	  	     fitness2 = (out2.getArray()[0]*(100/5))+60;	
	  	    }
	  		System.out.println("Fitness = "+Float.toString(fitness2));
...
//*******************************************************************************************************************************
			...
			double fitnessd = (fitness1+fitness2+fitness3)/3;
