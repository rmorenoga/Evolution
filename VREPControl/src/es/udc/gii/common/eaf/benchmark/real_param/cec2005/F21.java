...
/**
 * CEC 2005 F21: Rotated Hybrid Composition Function
 * @author Grupo Integrado de Ingeniería (<a href="http://www.gii.udc.es">www.gii.udc.es</a>) 
 * @since 1.0
 */
public class F21 extends CEC2005CompositionFunction {

    public F21(int dimension) {
        super(dimension);
    }
    ...
    protected final double[] calculateFit(double[] z) {
        ...
        fit[0] = F6(transform(z, o[0], lambda[0], M[0]));
        ...
        fit[4] = F8F2(transform(z, o[4], lambda[4], M[4]));
        fit[5] = F8F2(transform(z, o[5], lambda[5], M[5]));
        ...
        fMax[0] = F6(transform(y, null, lambda[0], M[0]));
        ...
        fMax[4] = F8F2(transform(y, null, lambda[4], M[4]));
        fMax[5] = F8F2(transform(y, null, lambda[5], M[5]));
