...
/*
 * S_Dtlz2_Objective.java
 *
 * Created on November 20, 2007, 4:35 PM
 *
 */
...
/**
 * CEC 2007 Testsuite: Extended, shifted DTLZ2 (S_DTLZ2)
 * @author Grupo Integrado de Ingeniería (<a href="http://www.gii.udc.es">www.gii.udc.es</a>) 
 * @since 1.0
 */
public class S_Dtlz2_Objective extends ExtendedShiftedObjectiveFunction {

    private int objNumber = 0;
    private int numberOfObjectives = 0;

    /** Creates a new instance of S_Dtlz2_Objective */
    public S_Dtlz2_Objective() {
    }
    
    /** Creates a new instance of S_Dtlz2_Objective */
    public S_Dtlz2_Objective(int dimension) {
        super(dimension);
    }    
    ...
    public double evaluate(double[] x) {
        ...
        if (objNumber > 1) {
            ff *= Math.sin(zz[(numberOfObjectives - objNumber + 1) - 1] *
                    Math.PI / 2.0);
            psum[objNumber - 1] = Math.sqrt(Math.pow(psum[objNumber - 1], 2) +
