...
/*
 * Sym_Part_Objective_1.java
 *
 * Created on November 20, 2007, 11:55 AM
 *
 */
 ...
 * @since 1.0
 */
public class Sym_Part_Objective_1 extends Sym_Part_Objective {

    /** Creates a new instance of Sym_Part_Objective_1 */
    public Sym_Part_Objective_1() {
    }
...
//			f1 += Math.pow(x1-j*b,2);
        ...
        f0 /= (double) values.length;
//	f1 /= (double)doubleValues.size();
