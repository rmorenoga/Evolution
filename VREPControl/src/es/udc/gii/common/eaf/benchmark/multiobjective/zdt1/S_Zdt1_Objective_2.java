...
/*
 * S_Zdt1_Objective_2.java
 *
 * Created on November 20, 2007, 1:14 PM
 *
 */
 ...
 * @since 1.0
 */
public class S_Zdt1_Objective_2 extends ExtendedShiftedObjectiveFunction {
    
    /** Creates a new instance of S_Zdt1_Objective_2 */
    public S_Zdt1_Objective_2() {       
    }

    /** Creates a new instance of S_Zdt1_Objective_2 */
    public S_Zdt1_Objective_2(int dimension) {       
        super(dimension);
    }
    ...
    public double evaluate(double[] x) {
        ...
        for (i = 1; i < nx; i++) {
            ...
            sum += zz[i];
            psum = Math.sqrt(Math.pow(psum, 2.0) + Math.pow(p[i], 2.0));
        }
