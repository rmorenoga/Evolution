...
/**
 * Base class for all shifted functions for the SOCO special issue on
 * scalability of evolutionary algorithms an dother metaheuristics for large scale continous 
 * optimization function (functions 1-11).
 * 
 * @author Grupo Integrado de Ingeniería (<a href="http://www.gii.udc.es">www.gii.udc.es</a>) 
 * @since 1.0
 */
public abstract class ShiftedObjectiveFunction extends SOCOObjectiveFunction {
