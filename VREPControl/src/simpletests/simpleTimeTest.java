...
public static void main(String[] args) {
		...
		int clientID = vrep.simxStart("127.0.0.1",19996,true,true,5000,5);
		if (clientID!=-1)
		{
...
//*******************************************************************************************************************************
		...
		int ret = vrep.simxLoadScene(clientID, "/home/rodr/EvolWork/Modular/ModularCPGA1.ttt", 0, vrep.simx_opmode_oneshot_wait);	
