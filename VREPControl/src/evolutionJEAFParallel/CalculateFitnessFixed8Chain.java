...
public class CalculateFitnessFixed8Chain extends ObjectiveFunction{

public double evaluate(double[] values) {
		
		int maxTries = 3;
		int myRank = MPI.COMM_WORLD.Rank();
		myRank = myRank + EvolutionJEAFFixed8Chain.startNumber;
...
//*******************************************************************************************************************************
		...
		rfitness = RunScene(vrep, clientID, "/home/rodrigo/V-REP/Modular/ModularCPGA1.ttt",  MaxTime);
		if(rfitness[0]==-1){
			RestartSim( myRank, j);
			continue;
		}
...
//*******************************************************************************************************************************		
		...
		rfitness = RunScene(vrep, clientID, "/home/rodrigo/V-REP/Modular/ModularCPGA2.ttt",  MaxTime);
		if(rfitness[0]==-1){
			RestartSim( myRank, j);
			continue;
		}
...
//*******************************************************************************************************************************		
		...
		rfitness = RunScene(vrep, clientID, "/home/rodrigo/V-REP/Modular/ModularCPGA3.ttt",  MaxTime);
		if(rfitness[0]==-1){
			RestartSim( myRank, j);
			continue;
		}
...
//*******************************************************************************************************************************		
		...
		rfitness = RunScene(vrep, clientID, "/home/rodrigo/V-REP/Modular/ModularCPGA4.ttt",  MaxTime);
		if(rfitness[0]==-1){
			RestartSim( myRank, j);
			continue;
		}
