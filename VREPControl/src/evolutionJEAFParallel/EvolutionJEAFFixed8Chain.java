...
public class EvolutionJEAFFixed8Chain {
...
//		}
		...
		StopTest stopTest;
		EAFRandom.init();
		algorithm = facade.createAlgorithm("" + "EvolconfigFixed8Chain.xml");
        stopTest = facade.createStopTest("./" + "EvolconfigFixed8Chain.xml");
