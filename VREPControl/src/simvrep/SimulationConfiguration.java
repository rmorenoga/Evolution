    ...
    static {
        try {
          ...
          //Control Parameters
            ...
            }else if (SimulationConfiguration.controller.contentEquals("CPGH") || SimulationConfiguration.controller.contentEquals("CPGHF") || SimulationConfiguration.controller.contentEquals("CPGHLog")){
