...
//		
//		OptimizationFunction<double[]> function = new EmH(10,300,2);
...
//		
////		HaeaStep step = new HaeaStep(POPSIZE, selection, operators);
...
//        		factory.HAEA(POPSIZE, operators, selection, MAXITERS);
//		
...
////		FileTracer tracer = new FileTracer("HAEAEmReal.txt", ',');
...
//        FileTracer file = new FileTracer("HAEAReal.txt");
