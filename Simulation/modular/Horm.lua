...
function receptors(hormones,rhorm,sensorO,connori,ampd,offd,phasediff,v,deltaparam,RecModel,Genmodel,annInputSwitch)
	local hormnew = {}
	local ampdnew = ampd
	local offdnew = offd
	local phasediffnew = {}
	...
	elseif (Recmodel == 'ANNBasic') then
		...
		ampdnew,offdnew,phasediffnew,vnew = receptorsANNB(hormfiltered,ampdnew,offdnew,phasediffnew,vnew,orifiltered,deltaparam,annInputSwitch)
